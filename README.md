...
> Presentation of the whole solution including sample analyse/fix of the SSO Authelia implementation generated by Claude using a Devoteam Slides Template: [Presentation](./docs/k3sdevlab.pdf)
