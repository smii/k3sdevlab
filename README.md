...
> Entirely vibe-coded using [Claude](https://claude.ai) (Claude Code CLI) across ~209 commits — from initial K3s bootstrap through Tekton pipelines, Falco eBPF security, and a 9-tab Homepage dashboard.<br><br>
> Presentation of the whole solution including sample analyse/fix of the SSO Authelia implementation: [Presentation](https://docs.google.com/presentation/d/1OuE8s5xf58n0wTcdCv4EHMIsg2s0dnWL/edit?usp=sharing&ouid=118061521910485194962&rtpof=true&sd=true)
