...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `proffesor-for-testing-agentic-qe-security-testing`                                |
| Version    | 1.0.4                                     |
...
**GitHub:** [proffesor-for-testing/agentic-qe](https://github.com/proffesor-for-testing/agentic-qe) — ⭐ 214 | Forks: 44
...
A focused security-testing Skill that codifies OWASP best practices into repeatable checks for audits, pentests, and CI/CD pipelines. Key features include systematic OWASP Top 10 validation, endpoint authentication and authorization verification (horizontal/vertical privilege tests), injection checks (SQL, XSS, command), dependency vulnerability scanning (npm audit, Snyk), and secret exposure detection (git-secrets, TruffleHog). It recommends SAST and DAST tools (SonarQube, Semgrep, OWASP ZAP, Burp) and highlights crypto, configuration, logging, and integrity checks such as HTTPS, proper password hashing, rate limiting, and audit trails. Use this Skill when performing security reviews, threat modeling, pre-release scans, or automating security gates in CI/CD. Core advantages are lowering breach risk through shift-left testing, creating repeatable compliance-ready workflows, and enabling continuous, attacker-minded defensive validation.
...
```bash
npx -y @lobehub/market-cli skills install proffesor-for-testing-agentic-qe-security-testing
```
...
npx -y @lobehub/market-cli skills install proffesor-for-testing-agentic-qe-security-testing --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install proffesor-for-testing-agentic-qe-security-testing --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install proffesor-for-testing-agentic-qe-security-testing --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install proffesor-for-testing-agentic-qe-security-testing --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install proffesor-for-testing-agentic-qe-security-testing --version 1.0.4
```
...
```bash
npx -y @lobehub/market-cli skills rate proffesor-for-testing-agentic-qe-security-testing --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment proffesor-for-testing-agentic-qe-security-testing -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment proffesor-for-testing-agentic-qe-security-testing
```
...
```bash
npx -y @lobehub/market-cli skills comments proffesor-for-testing-agentic-qe-security-testing
```
